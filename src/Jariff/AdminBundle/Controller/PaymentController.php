...
class PaymentController extends BaseController
{
    ...
    */
     ...
     *
     * @Route("/{id}/payment/edit", name="admin_payment_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}/payment/update", name="admin_payment_update")
