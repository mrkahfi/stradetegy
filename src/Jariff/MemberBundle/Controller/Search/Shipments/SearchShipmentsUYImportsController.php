...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\UYImports\FieldUYImportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsUYImportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/uy-imports/{page}",
     *   name     = "member_search_shipments_result_uy_imports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsUyImports:results.html.twig")
     */
    ...
    if (empty($s_cache->column))
        $fieldUsCustom->field_us_custom = array( "date",
            ...
            "quantity",
            "unit",
            "physical_units_quantity",
            "physical_units",
            "insurance_currency_of_origin",
            "currency_of_insurance",
            "freight_currency_of_origin",
            "currency_of_freight",
            "us_cif");
    else {
    ...
    $formFieldUsCustom = $this->createForm(new FieldUYImportFormType(), $fieldUsCustom, array(
        'action' => '',
        'method' => 'POST',
        ));
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/uy-imports/{page}",
     *   name     = "member_search_shipments_result_uy_imports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsUyImports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_py_imports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_uy_imports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array("date", "importer",
                "product", "country_of_origin","gross_weight","quantity");
        else {
            $fieldUsCustom->field_us_custom = (is_array($s_cache->column)) ? $s_cache->column : array($s_cache->column);
        }
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUyImports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_uy_imports', array('page' => $page, 's_cache' => $this->s_cache_json))
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-uy-imports",
     *   name     = "member_search_columns_category_submit_uy_imports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldUYImportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
            ));
        ...
        return $this->redirectUrl('member_search_shipments_result_uy_imports', array('s_cache' => $s_cache));
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-show-uy-imports",
     *   name     = "member_search_columns_category_columns_show_uy_imports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUyImports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-uy-imports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_uy_imports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUyImports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,"params" => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/uy-imports/jsonp",
     *   name     = "member_search_shipments_result_uy_imports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
    ...
    public function resultAjaxJsonpAction()
    {
        ...
        $client = new \Elastica\Client(array("host" => $this->container->getParameter('es_server')));
        $searchable = new Index($client, 'stradetegy_uy_imports');
...
//        }
        ...
        if ($res->getNbResults() == 0) {
            ...
            $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_uy_imports', array('s_cache' => $this->s_cache_json)));
        ...
        //         ));
            ...
            $urlChanges = $this->generateUrl('member_search_shipments_result_uy_imports', array('page' => $page, 's_cache' => $this->s_cache_json));
        ...
        foreach ($res->getCurrentPageResults()->getResults() as $r) {
            ...
            data-url="' . $this->generateUrl('company_display_one_shipments_uy_imports', array(
