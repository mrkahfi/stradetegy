var mapImporter = function () {
    ...
    var values = {
        ...
        raw_consignee_address_others: value.raw_consignee_address_others,
...
var reduceImporter = function (key, vals) {
    var r = {total_quantity: 0, total_container_count: 0, total_weight: 0, total_shipment: 0, total_measure: 0};
...
var resSup1 = db.usa_rewrite.mapReduce(mapImporter, reduceImporter,
    { query: {"value.slug_shipper_name": {$ne: "na"},
        $or: [
            { "value.slug_shipper_name": {$ne: ""}}
        ]}, out: "usa_exporter_detail", sort: {"value.actual_arrival_date": 1}});