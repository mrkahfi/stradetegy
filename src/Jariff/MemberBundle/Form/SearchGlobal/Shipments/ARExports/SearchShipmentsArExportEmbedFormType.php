...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\ARExports\FieldCollectFormARExportType;
use Jariff\MemberBundle\Form\SearchGlobal\Field\FieldQFormType;


class SearchShipmentsArExportEmbedFormType extends AbstractType
{
        ...
        $builder
           ->add('collect', 'collection',
                array(
                    ...
                    'type' => new FieldCollectFormARExportType(),
                    'by_reference' => false,
                    'allow_delete' => true,
                    'allow_add'    => true,
