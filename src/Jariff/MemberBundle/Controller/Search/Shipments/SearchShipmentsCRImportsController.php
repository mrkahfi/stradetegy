...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\CRImports\FieldCRImportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsCRImportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/cr-imports/{page}",
     *   name     = "member_search_shipments_result_cr_imports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsCrImports:results.html.twig")
     */
    public function resultAction($page = 1)
    {
        ...
        $formFieldUsCustom = $this->createForm(new FieldCRImportFormType(), $fieldUsCustom, array(
            'action' => '',
            'method' => 'POST',
        ));
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/cr-imports/{page}",
     *   name     = "member_search_shipments_result_cr_imports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsCrImports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_cr_imports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_cr_imports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsCrImports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_cr_imports', array('page' => $page, 's_cache' => $this->s_cache_json))
                )
            )
        );
    }
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-cr-imports",
     *   name     = "member_search_columns_category_submit_cr_imports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldCRImportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
        ));
        ...
        return $this->redirectUrl('member_search_shipments_result_cr_imports', array('s_cache' => $s_cache));

    }

    /**
     * @Route(
     *   "/search-shipments-columns-show-cr-imports",
     *   name     = "member_search_columns_category_columns_show_cr_imports"
     * )
     *
     *
     */
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-cr-imports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_cr_imports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsCrImports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,'params' => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/cr-imports/jsonp",
     *   name     = "member_search_shipments_result_cr_imports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        }
        ...
        if ($res->getNbResults() == 0) {
            ...
            $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_cr_imports', array('s_cache' => $this->s_cache_json)));
        ...
        if ($maxTime > 1) {
            ...
            $urlChanges = $this->generateUrl('member_search_shipments_result_cr_imports', array('page' => $page, 's_cache' => $this->s_cache_json));
        ...
        foreach ($res->getCurrentPageResults()->getResults() as $r) {
            ...
            $columnMd['detail_company'] = ' <a href="#"
                                                       ...
                                                       data-url="' . $this->generateUrl('company_display_one_shipments_cr_imports', array(
