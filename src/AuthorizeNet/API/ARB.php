 ...
 * @subpackage AuthorizeNetARB
 */
class ARB extends AuthorizeNet\Request
{
     ...
     */
    public function createSubscription(AuthorizeNet\Type\Subscription $subscription)
    {
     ...
     * @return AuthorizeNetARB_Response
     */
    public function updateSubscription($subscriptionId, AuthorizeNet\Type\Subscription $subscription)
    {
