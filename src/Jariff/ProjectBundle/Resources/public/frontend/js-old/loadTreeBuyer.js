        ...
        var ht = new $jit.Hypertree({
            ...
            Tips: {  
                ...
                onShow: function(tip, node) {  
                    tip.innerHTML = "<div  style='background-color:#F8FFC9;text-align:center;border-radius:5px; padding:10px 10px;' class='node-tip'><p style='font-size:100%;font-weight:bold;'>"+node.name+"</p><p style='font-size:50%pt'>"+node.data.shipper_address+"</p></div>"; 
                }     
            },
            Events: {  
                enable: true,  
            ...
            onPlaceLabel: function (domElement, node) {
                ...
                console.log(node.data.shipper_address);
            },
            ...
            onComplete: function (node) {
                ...
                type = isOdd(dot._depth) ? 'Supplier' : 'Buyer';
                html = "<div id='node-info'>Company Name<h7><div id='company-name'><p style='font-size:120%;'>" + dot.name + "</p></div></h7>Company Type<div id='company-type'><p style='font-size:120%;'>"+ type +"</p></div>Featured Address<div id='featured-address'><p style='font-size:120%;'>"+dot.data.shipper_address+"</p></div>Connections<div id='connection-count'><p style='font-size:120%;'>"+connCount+"</p></div>Showing Connections<div id='showing-connection'><p style='font-size:120%;'>"+showingCount+"</p></div></div>";
