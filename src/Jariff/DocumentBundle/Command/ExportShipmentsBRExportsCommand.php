...
class ExportShipmentsBRExportsCommand extends ContainerAwareCommand
{

    protected function configure()
    {
        $this
            ->setName('jariff:cron:export-shipments-br-exports')
            ->setDescription('Mengeksekusi file export shipments BR EX')
            ->setHelp('<<<EOF
            <info>jariff:cron:export</info>
            Command digunakan untuk menyimpan data pencarian

            Syntax :
            php app/console jariff:cron:export-shipments-br-exports
            EOF'
            );
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        if (flock($fp, LOCK_EX | LOCK_NB)) {
            ...
            echo "mulai\n";
            $exportDownloadQueque = $em->getRepository('JariffMemberBundle:ExportTools')->findOneBy(array('process' => 1,'collection' => 'br-exports'));
            ...
            ->setTitle("Shipments Data BR Exports");
...
//            $highlight,
            ...
            $searchable = new Index($client, 'stradetegy-ex-br');
        ...
        'country', 'nomen','product','fob', 'quantity', 'measure', 'net');
            ...
            $columns = array();
            $cell = $phpExcelObject->createSheet(0)->setTitle('Shipments BR Exports');
            $i = 0;
