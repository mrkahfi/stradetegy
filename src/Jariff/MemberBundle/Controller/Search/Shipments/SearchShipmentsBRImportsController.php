 ...
 * @Route("/member")
 */
class SearchShipmentsBRImportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/br-imports/{page}",
     *   name     = "member_search_shipments_result_br_imports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsBrImports:results.html.twig")
     */
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/br-imports/{page}",
     *   name     = "member_search_shipments_result_br_imports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsBrImports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_br_imports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_br_imports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsBrImports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_br_imports', array('page' => $page, 's_cache' => $this->s_cache_json))
                    )
                )
            );
    }
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-br-imports",
     *   name     = "member_search_columns_category_submit_br_imports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        return $this->redirectUrl('member_search_shipments_result_br_imports', array('s_cache' => $s_cache));

    }

    /**
     * @Route(
     *   "/company-display-one-shipments-br-imports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_br_imports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsBrImports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,'params' => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-show-br-imports",
     *   name     = "member_search_columns_category_columns_show_br_imports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsBrImports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/br-imports/jsonp",
     *   name     = "member_search_shipments_result_br_imports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        }
    ...
    if ($res->getNbResults() == 0) {
        ...
        $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_br_imports', array('s_cache' => $this->s_cache_json)));
...
if ($maxTime > 1) {
    ...
    $urlChanges = $this->generateUrl('member_search_shipments_result_br_imports', array('page' => $page, 's_cache' => $this->s_cache_json));
...
foreach ($res->getCurrentPageResults()->getResults() as $r) {
    ...
    data-url="' . $this->generateUrl('company_display_one_shipments_br_imports', array(
