...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\ECExports\FieldECExportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsECExportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/ec-exports/{page}",
     *   name     = "member_search_shipments_result_ec_exports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsEcExports:results.html.twig")
     */
    public function resultAction($page = 1)
    {
        ...
        $formFieldUsCustom = $this->createForm(new FieldECExportFormType(), $fieldUsCustom, array(
            'action' => '',
            'method' => 'POST',
            ));
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/ec-exports/{page}",
     *   name     = "member_search_shipments_result_ec_exports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsEcExports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $highlight = array(
            "highlight" => array(
                ...
                "fields" => array(
                    ...
                    "comercial_description" => array("number_of_fragments" => 0, "pre_tags" => array("<strong>"), "post_tags" => array("</strong>")),
                    )
                )
            );
        ...
        $searchable = new Index($client, 'stradetegy_ec_exports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_ec_exports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        $fieldUsCustom = new FieldUsCustom();
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array("date", "exporter",
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsEcExports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_cr_exports', array('page' => $page, 's_cache' => $this->s_cache_json))
                    )
                )
            );
    }
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-ec-exports",
     *   name     = "member_search_columns_category_submit_ec_exports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldECExportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
            ));
        ...
        return $this->redirectUrl('member_search_shipments_result_ec_exports', array('s_cache' => $s_cache));

    }

    /**
     * @Route(
     *   "/search-shipments-columns-show-cr-exports",
     *   name     = "member_search_columns_category_columns_show_cr_exports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsEcExports\Add\Form:field_column.html.twig', $params),
...
//    /**
//     * @Route(
//     *   "/member-display-modal-save-shipments",
...
//     *
//     */
//    function displayMemberSaveShipmentsAction()
//    {
//
...
//                array(
//                    'success' => true,
//                    'html_string' => $this->renderView('JariffMemberBundle:Search\Shipments\Add:modal_form_save.html.twig', $params),
//                    's_cache' => ''
//                )
//            )
//        );
//    }
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-ec-exports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_ec_exports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsEcExports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret, 'params' => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/ec-exports/jsonp",
     *   name     = "member_search_shipments_result_ec_exports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        }
        ...
        if ($res->getNbResults() == 0) {
            ...
            $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_ec_exports', array('s_cache' => $this->s_cache_json)));
        ...
        $urlChanges = $this->generateUrl('member_search_shipments_result_ec_exports', array('page' => $page, 's_cache' => $this->s_cache_json));
    ...
    foreach ($res->getCurrentPageResults()->getResults() as $r) {
        ...
        data-whatever="' . $r->getHit()["_source"]['exporter'] . '"
        class="j-modal-company-one-shipments"
        data-toggle="modal" data-target="#myModal" data-backdrop="static"
        data-url="' . $this->generateUrl('company_display_one_shipments_ec_exports', array(
