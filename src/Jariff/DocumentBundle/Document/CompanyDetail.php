...
/**
 * @MongoDB\Document(collection="company_detail")
 *
 */
class CompanyDetail {
    ...
    /** @MongoDB\String */
    protected $shipper_name_pr;

    /** @MongoDB\String */
    protected $shipper_address_pr;
    ...
    /** @MongoDB\String */
    protected $consignee_name_pr;

    /** @MongoDB\String */
    protected $consignee_address_pr;
     ...
     * Set shipperNamePr
     *
     * @param string $shipperNamePr
     * @return self
     */
    public function setShipperNamePr($shipperNamePr)
    {
        $this->shipper_name_pr = $shipperNamePr;
        return $this;
    }
     ...
     * Get shipperNamePr
     *
     * @return string $shipperNamePr
     */
    public function getShipperNamePr()
    {
        return $this->shipper_name_pr;
    }

    /**
     * Set shipperAddressPr
     *
     * @param string $shipperAddressPr
     * @return self
     */
    public function setShipperAddressPr($shipperAddressPr)
    {
        $this->shipper_address_pr = $shipperAddressPr;
        return $this;
    }

    /**
     * Get shipperAddressPr
     *
     * @return string $shipperAddressPr
     */
    public function getShipperAddressPr()
    {
        return $this->shipper_address_pr;
    }

    /**
     * Set consigneeNamePr
     *
     * @param string $consigneeNamePr
     * @return self
     */
    public function setConsigneeNamePr($consigneeNamePr)
    {
        $this->consignee_name_pr = $consigneeNamePr;
        return $this;
    }
     ...
     * Get consigneeNamePr
     *
     * @return string $consigneeNamePr
     */
    public function getConsigneeNamePr()
    {
        return $this->consignee_name_pr;
    }

    /**
     * Set consigneeAddressPr
     *
     * @param string $consigneeAddressPr
     * @return self
     */
    public function setConsigneeAddressPr($consigneeAddressPr)
    {
        $this->consignee_address_pr = $consigneeAddressPr;
        return $this;
    }

    /**
     * Get consigneeAddressPr
     *
     * @return string $consigneeAddressPr
     */
    public function getConsigneeAddressPr()
    {
        return $this->consignee_address_pr;
    }
}
