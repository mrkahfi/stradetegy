...
class MemberController extends BaseController
{
     ...
     *     name = "admin_member_reset_password_update",
     *     requirements = {
     *       "id"  : "\d+"
     *     }
     * )
     ...
     * @Route(
     *     "/{id}/reset-password",
     *     name = "admin_member_reset_password",
     *     requirements = {
     *       "id"  : "\d+"
     *     }
     * )
    ...
    public function jsonIndexAction(Request $request)
    {
        ...
        foreach ($entities as $r) {
            $data[] = array(
                'id'            => $r->getId(),
                'm.number'         => $r->getNumber(),
                'm.status'         => $r->getStatus(),
                'm.email'         => $r->getEmail(),
                'm.token'         => $r->getToken(),
