...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\UYExports\FieldUYExportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsUYExportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/uy-exports/{page}",
     *   name     = "member_search_shipments_result_uy_exports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsUyExports:results.html.twig")
     */
    public function resultAction($page = 1)
    {
        ...
        $formFieldUsCustom = $this->createForm(new FieldUYExportFormType(), $fieldUsCustom, array(
            'action' => '',
            'method' => 'POST',
            ));
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/uy-exports/{page}",
     *   name     = "member_search_shipments_result_uy_exports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsUyExports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_uy_exports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_uy_exports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array("date", "exporter",
                "country_destination", "gross_weight","product","quantity");
        else {
            $fieldUsCustom->field_us_custom = (is_array($s_cache->column)) ? $s_cache->column : array($s_cache->column);
        }
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUyExports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_uy_exports', array('page' => $page, 's_cache' => $this->s_cache_json))
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-uy-exports",
     *   name     = "member_search_columns_category_submit_uy_exports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldUYExportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
            ));
        ...
        return $this->redirectUrl('member_search_shipments_result_uy_exports', array('s_cache' => $s_cache));
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-show-uy-exports",
     *   name     = "member_search_columns_category_columns_show_uy_exports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUyExports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-uy-exports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_uy_exports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUyExports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,"params" => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/uy-exports/jsonp",
     *   name     = "member_search_shipments_result_uy_exports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        }
        ...
        if ($res->getNbResults() == 0) {
            ...
            $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_uy_exports', array('s_cache' => $this->s_cache_json)));
        ...
        $urlChanges = $this->generateUrl('member_search_shipments_result_uy_exports', array('page' => $page, 's_cache' => $this->s_cache_json));
    ...
    foreach ($res->getCurrentPageResults()->getResults() as $r) {
        ...
        data-url="' . $this->generateUrl('company_display_one_shipments_uy_exports', array(
