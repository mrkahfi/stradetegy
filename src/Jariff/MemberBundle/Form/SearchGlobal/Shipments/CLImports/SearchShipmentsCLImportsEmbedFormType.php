...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\ARImports\FieldCollectFormARImportsType;
use Jariff\MemberBundle\Form\SearchGlobal\Field\FieldQFormType;


class SearchShipmentsClImportsEmbedFormType extends AbstractType
{
        ...
        $builder
           ->add('collect', 'collection',
                array(
                    ...
                    'type' => new FieldCollectFormCLImportsType(),
                    'by_reference' => false,
                    'allow_delete' => true,
                    'allow_add'    => true,
