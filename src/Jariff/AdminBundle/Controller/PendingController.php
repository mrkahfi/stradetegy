...
class PendingController extends BaseController
{
     ...
     *
     * @Route("/index", name="admin_pending_index")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @ Route("/create", name="admin_pending_create")
     * @Method("POST")
    ...
    */
     ...
     *
     * @ Route("/new", name="admin_pending_new")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/update/{token}", name="admin_pending_update")
     * @Method("PUT")
     ...
     *
     * @Route("/delete/{token}", name="admin_pending_delete")
     * @Method("DELETE")
     */
