...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\VEExports\FieldVEExportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsVEExportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/ve-exports/{page}",
     *   name     = "member_search_shipments_result_ve_exports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsVeExports:results.html.twig")
     */
    ...
    $formFieldUsCustom = $this->createForm(new FieldVEExportFormType(), $fieldUsCustom, array(
        'action' => '',
        'method' => 'POST',
        ));
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/ve-exports/{page}",
     *   name     = "member_search_shipments_result_ve_exports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsVeExports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_ve_exports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_ve_exports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        $fieldUsCustom = new FieldUsCustom();
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array("date","chapter_description","hs_code","payment","hs_code_description","exporter","custom","transport_type",
                "dest_country","dest_port","gross_weight","net_weight");
        else {
            $fieldUsCustom->field_us_custom = (is_array($s_cache->column)) ? $s_cache->column : array($s_cache->column);
        }
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsVeExports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_ve_exports', array('page' => $page, 's_cache' => $this->s_cache_json))
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-ve-exports",
     *   name     = "member_search_columns_category_submit_ve_exports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldVEExportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
            ));
        ...
        return $this->redirectUrl('member_search_shipments_result_ve_exports', array('s_cache' => $s_cache));
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-show-ve-exports",
     *   name     = "member_search_columns_category_columns_show_ve_exports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsVeExports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-ve-exports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_ve_exports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsVeExports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,"params" => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/ve-exports/jsonp",
     *   name     = "member_search_shipments_result_ve_exports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        }
       ...
       if ($res->getNbResults() == 0) {
            ...
            $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_ve_exports', array('s_cache' => $this->s_cache_json)));
...
if ($this->get('session')->get('checkSubmit')) {
    ...
    if (!empty($cek)) {
        if (($cek->getTotal() + 1) > $active_subscription->getSearchValue()) {
            ...
            $urlChanges = $this->generateUrl('member_search_shipments_result_ve_exports', array('page' => $page, 's_cache' => $this->s_cache_json));
        ...
        foreach ($res->getCurrentPageResults()->getResults() as $r) {
            ...
            data-url="' . $this->generateUrl('company_display_one_shipments_ve_exports', array(
