...
class CountryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JariffMemberBundle:Country')->findAll();
     ...
     * @Method("POST")
     * @Template("JariffMemberBundle:Country:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JariffMemberBundle:Country')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JariffMemberBundle:Country:edit.html.twig")
     */
