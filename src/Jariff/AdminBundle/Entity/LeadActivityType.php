...
/**
 * @ORM\Entity(repositoryClass="Jariff\AdminBundle\Repository\LeadActivityTypeRepository")
 * @ORM\Table(name="lead_activity_type")
...
class LeadActivityType
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="LeadActivity", mappedBy="type", cascade={"all"})
     */
    protected $activity;
