...
class SupplierWorldMapController extends BaseController
{
    /**
     * @Route(
     *   "/world-map/supplier/{slug}/{page}",
     *   name     = "world_map_supplier", 
     *   defaults = {
     *     "slug"  : "",
     *     "page"  : "1"
     *   },
    ...
    public function indexAction($slug, $page)
    {
        ...
        return $this->render('JariffProjectBundle:Default:world_map_supplier.html.twig',
            array(
     ...
     *
     * @Route("/world-map/supplier/json/{slug}/{page}", 
     * name="world_map_supplier_json",
     *   defaults = {
     *     "slug"  : "",
     *     "page"  : "0"
     *   },
    ...
    {
        $dataChild2 = $this->repoMongo("JariffDocumentBundle:TradeMapSupplier")->findOneBy(array('parent' => $slug));
        $page++;
    ...
    /**
     * @Route(
     *   "/world-map/suppliers-of/{key}/{page}",
     *   name     = "world_map_search_supplier",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
    ...
    public function suppliersAction($key, $page = 1)
    {
        ...
        if (!empty($key)) {
            ...
            // $result->setUsedRoute('world_map_search_supplier');
            $message = "founded";
        ...
        return array(
            ...
            'message' => $message,
            'totalSupplier' => empty($result) ? 0 : Util::ribuan($result->getTotalItemCount()),
            );
    }


    /**
     * @Route("/world-map/ajax-supplier", name="ajax_world_map_supplier_search")
     * @Template("JariffProjectBundle:Default:result-suppliers-world-map.html.twig")
     * @Method("GET")
     */
    public function resultGlobalSupplierAction($page = 1)
    {
