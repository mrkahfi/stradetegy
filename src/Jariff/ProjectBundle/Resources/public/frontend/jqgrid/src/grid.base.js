	...
	styleUI : {
		...
		Bootstrap : {
			...
			base : {
				...
				pgButtonBox : "",
				icon_first : "icon-step-backward",
				icon_prev : "icon-backward",
				icon_next: "icon-forward",
				icon_end: "icon-step-forward",
				icon_asc : "icon-triangle-top",
				icon_desc : "icon-triangle-bottom",
