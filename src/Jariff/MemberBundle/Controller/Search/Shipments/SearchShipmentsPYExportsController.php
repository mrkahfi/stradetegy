...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\PYExports\FieldPYExportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsPYExportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/py-exports/{page}",
     *   name     = "member_search_shipments_result_py_exports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsPyExports:results.html.twig")
     */
    public function resultAction($page = 1)
    {
        ...
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array("date",
                ...
                "transport_type",
                "transport_company",
                "transportist_country",
                "manifest");
        else {
            $fieldUsCustom->field_us_custom = (is_array($s_cache->column)) ? $s_cache->column : array($s_cache->column);
        }

        $formFieldUsCustom = $this->createForm(new FieldPYExportFormType(), $fieldUsCustom, array(
            'action' => '',
            'method' => 'POST',
        ));
...
if (!$active_subscription->getEverythingPlan()) {
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/py-exports/{page}",
     *   name     = "member_search_shipments_result_py_exports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsPyExports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_py_exports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_py_exports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array("date", "exporter",
                "consignee", "destiny_country","product","quantity");
        else {
            $fieldUsCustom->field_us_custom = (is_array($s_cache->column)) ? $s_cache->column : array($s_cache->column);
        }
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsPyExports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_py_exports', array('page' => $page, 's_cache' => $this->s_cache_json))
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-py-exports",
     *   name     = "member_search_columns_category_submit_py_exports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldPYExportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
        ));
        ...
        return $this->redirectUrl('member_search_shipments_result_py_exports', array('s_cache' => $s_cache));
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-show-py-exports",
     *   name     = "member_search_columns_category_columns_show_py_exports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsPyExports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-py-exports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_py_exports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsPyExports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,"params" => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/py-exports/jsonp",
     *   name     = "member_search_shipments_result_py_exports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
if ($res->getNbResults() == 0) {
            ...
            $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_py_exports', array('s_cache' => $this->s_cache_json)));
...
if ($this->get('session')->get('checkSubmit')) {
    ...
    if (!empty($cek)) {
        if (($cek->getTotal() + 1) > $active_subscription->getSearchValue()) {
            ...
            $urlChanges = $this->generateUrl('member_search_shipments_result_py_exports', array('page' => $page, 's_cache' => $this->s_cache_json));
        ...
        foreach ($res->getCurrentPageResults()->getResults() as $r) {
            ...
            $columnMd['detail_company'] = ' <a href="#"
                                                       ...
                                                       data-url="' . $this->generateUrl('company_display_one_shipments_py_exports', array(
