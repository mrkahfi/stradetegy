...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\CAExports\FieldCollectFormCAExportType;
use Jariff\MemberBundle\Form\SearchGlobal\Field\FieldQFormType;


class SearchShipmentsCAImportEmbedFormType extends AbstractType
{
        ...
        $builder
           ->add('collect', 'collection',
                array(
                    ...
                    'type' => new FieldCollectFormCAImportType(),
                    'by_reference' => false,
                    'allow_delete' => true,
                    'allow_add'    => true,
