 ...
 * @Route("/member")
 */
class SearchGlobalController extends BaseController
{

    /**
     * @Route(
     *   "/search-global",
     *   name     = "member_search_global"
     * )
     *
     * @Template("JariffMemberBundle:Search\Global:index.html.twig")
     */
     ...
     *   name     = "member_search_global_submit"
     * )
     * @Method("POST")
     * @Template("JariffMemberBundle:Search\Global:index.html.twig")
     */
    public function submitAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            if ($data->getCategory() == 'shipments') {
                ...
                return $this->redirectUrl('member_search_global_result', array(
    ...
    /**
     * @Route(
     *   "/search-global-category-submit",
     *   name     = "member_search_global_category_submit"
     * )
     * @Method("POST")
     * @Template("JariffMemberBundle:Search\Global:index.html.twig")
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        return new Response(
            json_encode(array(
                'success' => true,
                'urls' => $this->generateUrl('member_search_global_result', array('s_cache' => $s_cache))
            ))
        );
    ...
    /**
     * @Route(
     *   "/search-res/buyers/{page}",
     *   name     = "member_buyers_res",
     *   options={"expose"=true}
     * )
     *
     *
    ...
    public function buyersSearchAction($page = 1)
    {
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_buyers_res', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
...
//
//            if (($resCek->getNbResults() + 1) > $member_search->getSearchValue()) {
//                return $this->errorRedirect('Your search limit', 'member_search_global');
//            }
//
...
//
        ...
        // var_dump($res->getCurrentPageResults()->getResults()[0]->getData()["slug_consignee_name"]);
        ...
        return new Response(json_encode(
            array(
                ...
                'html_string' => $this->renderView('JariffMemberBundle:Search\Global\New\Append:buyers.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/search-global-result/{category}/{page}",
     *   name     = "member_search_global_result",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\Global:results.html.twig")
     */
    public function resultAction($category, $page = 1)
    {
        ...
        $entityPrimary = new SearchGlobalModel();
        ...
        if (!empty($s_cache)) {
            ...
            $url_window = $this->generateUrl('member_search_global_submit', array('category' => $category, 'keyword' => $keyword, 's_cache' => $this->s_cache_json));
    ...
    /**
     * @Route(
     *   "/search-res/suppliers/{page}",
     *   name     = "member_suppliers_res",
     *   options={"expose"=true}
     * )
     *
     *
...
//
        ...
        $options = array('proximity' => 3);
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_suppliers_res', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        return new Response(json_encode(
            array(
                "success" => true,
                'total_results' => $twigEx->ribuan($res->getNbResults()),
                'html_string' => $this->renderView('JariffMemberBundle:Search\Global\New\Append:suppliers.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/search-res/suppliers-form-country",
     *   name     = "member_suppliers_show_filter_country_res",
     *   options={"expose"=true}
     * )
     *
     *
    ...
    /**
     * @Route(
     *   "/search-res/logistics/{page}",
     *   name     = "member_logistics_res",
     *   options={"expose"=true}
     * )
     *
     *
    ...
    public function logiticsSearchAction($page = 1)
    {
        ...
        $html = $view->render($res, function ($page = 1) {
            return $this->generateUrl('member_logistics_res', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
...
//
    ...
    public function submitCountryAction(Request $request, $cat)
    {
        ...
        return new Response(json_encode(
                array(
                    'success' => true,
                    'urls' => $this->generateUrl('member_search_global_result', array('category' => $cat, 's_cache' => $s_cache)),
