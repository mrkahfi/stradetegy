...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\PYImports\FieldPYImportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsPYImportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/py-imports/{page}",
     *   name     = "member_search_shipments_result_py_imports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsPyImports:results.html.twig")
     */
    ...
    $formFieldUsCustom = $this->createForm(new FieldPYImportFormType(), $fieldUsCustom, array(
        'action' => '',
        'method' => 'POST',
        ));
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/py-imports/{page}",
     *   name     = "member_search_shipments_result_py_imports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsPyImports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_py_imports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array("date", "importer",
                "supplier", "product","gross_kilo","quantity");
        else {
            $fieldUsCustom->field_us_custom = (is_array($s_cache->column)) ? $s_cache->column : array($s_cache->column);
        }
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsPyImports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_py_imports', array('page' => $page, 's_cache' => $this->s_cache_json))
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-py-imports",
     *   name     = "member_search_columns_category_submit_py_imports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldPYImportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
            ));
        ...
        return $this->redirectUrl('member_search_shipments_result_py_imports', array('s_cache' => $s_cache));
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-show-py-imports",
     *   name     = "member_search_columns_category_columns_show_py_imports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsPyImports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-py-imports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_py_imports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsPyImports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,"params" => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/py-imports/jsonp",
     *   name     = "member_search_shipments_result_py_imports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        }
        ...
        if ($res->getNbResults() == 0) {
            ...
            $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_py_imports', array('s_cache' => $this->s_cache_json)));
        ...
        $urlChanges = $this->generateUrl('member_search_shipments_result_py_imports', array('page' => $page, 's_cache' => $this->s_cache_json));
    ...
    foreach ($res->getCurrentPageResults()->getResults() as $r) {
        ...
        data-url="' . $this->generateUrl('company_display_one_shipments_py_imports', array(
