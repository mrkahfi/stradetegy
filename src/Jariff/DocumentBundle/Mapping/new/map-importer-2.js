var mapImporter = function () {
    ...
    emit(value.slug_consignee_name, values);
}
...
var resSup1 = db.usa_importer_detail.mapReduce(mapImporter, reduceImporter,
    { out: "usa_importer", sort: {"value.actual_arrival_date": 1}});