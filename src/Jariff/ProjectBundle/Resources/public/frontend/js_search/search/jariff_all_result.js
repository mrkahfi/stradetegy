$(document).ready(function () {
    ...
    $('.j-condition').on('click', function () {
        ...
        if (numItems < 14) {
            ...
            $.ajax({
                type: 'GET',
                url: Routing.generate('demo_search_fix_append_form'),
...
//                return false;
    ...
    $.ajax({
        type: 'GET',
        url: Routing.generate('demo_search_fix_ajax_total_product'),
...
//                $('#importers').tab('show');
    ...
    $('.pagination ul li a').on('click', function () {
        ...
        var urlSearch = Routing.generate('demo_search_result');
    ...
    function ajaxResultData(formSubmit) {
        $.ajax({
            type: 'GET',
            url: Routing.generate('demo_search_filter_ajax'),
            data: formSubmit,
            beforeSend: function () {
