var mapImporter = function () {
    ...
    var values = {
        ...
        shipper_name_pr: value.shipper_name,
        shipper_address_pr: value.shipper_address,
        ...
        consignee_name_pr: value.consignee_name,
        consignee_address_pr: value.consignee_address,
        ...
        slug_country: value.slug_country_ori_shipper,
        ...
        total_company: value.total_company,
        company_as: 'product'
    };
...
var reduceImporter = function (key, vals) {
    ...
    for (var i = 0; i < vals.length; i++) {
        ...
        r.shipper_name_pr = vals[i].shipper_name_pr;
        r.shipper_address_pr = vals[i].shipper_address_pr;
        ...
        r.consignee_name_pr = vals[i].consignee_name_pr;
        r.consignee_address_pr = vals[i].consignee_address_pr;
...
var resSup1 = db.usa_product.mapReduce(mapImporter, reduceImporter,
    { out: {merge:"all_data"}});