...
class LeadController extends BaseController
{
     ...
     *
     * @Route("/{id}/convert-to-client", name="super_admin_lead_convert")
     * @Template()
     */
     ...
     *
     * @Route("/index", name="super_admin_lead_index")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/create", name="super_admin_lead_create")
    ...
    */
     ...
     *
     * @Route("/new", name="super_admin_lead_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="super_admin_lead_edit")
     * @Template("JariffAdminBundle:Lead:new.html.twig")
     */
    ...
    */
     ...
     *
     * @Route("/update/{id}", name="super_admin_lead_update")
     * @Template("JariffAdminBundle:Lead:new.html.twig")
     */
