...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\ECImports\FieldECImportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsECImportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/ec-imports/{page}",
     *   name     = "member_search_shipments_result_ec_imports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsEcImports:results.html.twig")
     */
...
$formFieldUsCustom = $this->createForm(new FieldECImportFormType(), $fieldUsCustom, array(
    'action' => '',
    'method' => 'POST',
    ));
...
return array(
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/ec-imports/{page}",
     *   name     = "member_search_shipments_result_ec_imports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsEcImports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_ec_imports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_ec_imports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsEcImports\Add:results_ajax.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-ec-imports",
     *   name     = "member_search_columns_category_submit_ec_imports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldECImportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
            ));
        ...
        return $this->redirectUrl('member_search_shipments_result_ec_imports', array('s_cache' => $s_cache));

    }

    /**
     * @Route(
     *   "/search-shipments-columns-show-ec-imports",
     *   name     = "member_search_columns_category_columns_show_ec_imports"
     * )
     *
     *
     */
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-ec-imports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_ec_imports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsEcImports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,'params' => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/ec-imports/jsonp",
     *   name     = "member_search_shipments_result_ec_imports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
if ($res->getNbResults() == 0) {
    ...
    $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_ec_imports', array('s_cache' => $this->s_cache_json)));
...
$urlChanges = $this->generateUrl('member_search_shipments_result_ec_imports', array('page' => $page, 's_cache' => $this->s_cache_json));
...
foreach ($res->getCurrentPageResults()->getResults() as $r) {
    ...
    data-url="' . $this->generateUrl('company_display_one_shipments_ec_imports', array(
