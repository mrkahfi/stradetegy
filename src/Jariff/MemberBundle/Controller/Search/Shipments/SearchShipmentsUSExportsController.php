...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\USExports\FieldUSExportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsUSExportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/us-exports/{page}",
     *   name     = "member_search_shipments_result_us_exports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsUsExports:results.html.twig")
     */
    public function resultAction($page = 1)
    {
        ...
        $formFieldUsCustom = $this->createForm(new FieldUsExportFormType(), $fieldUsCustom, array(
            'action' => '',
            'method' => 'POST',
            ));
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-us-exports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_us_exports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return  new Response($this->renderView('JariffMemberBundle:Search\ShipmentsUsExports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret->getResults()[0]->getHit()['_source'], 'params' => $params)));
    ...
    /**
     * @Route(
     *   "/shipments-search-not-valid-date-us-exports/{page}",
     *   name     = "member_search_result_not_valid_date_us_exports"
     * )
     *
     *
     */
    ...
    /**
     * @Route(
     *   "/search--add-contact-company-us-export",
     *   name     = "member_search_add_contact_company_us_exports"
     * )
     *
     *
     */
    public function submitAddContactCompanyCategoryAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUsExports\Add:table_selected_company.html.twig', $params),
                    's_cache' => '',
    ...
    /**
     * @Route(
     *   "/search-delete-contact-company-us-export",
     *   name     = "member_search_delete_contact_company_us_exports"
     * )
     *
     *
     */
    ...
    /**
     * @Route(
     *   "/search-submit-selected-company-us-export",
     *   name     = "member_search_submit_selected_company_us_exports"
     * )
     *
     *
     */
    ...
    /**
     * @Route(
     *   "/search-submit-contact-history-company-us-export",
     *   name     = "member_search_submit_contact_history_company_us_exports"
     * )
     *
     *
     */
    public function contactHistoryCompanyCategoryAction(Request $request)
    {
        ...
        if (empty($company_as))
            $company_as = 'shipper_name';

        $entities = $this->repo("JariffMemberBundle:ContactCompany")->findBy(array(
            'member' => $this->getUser()->getId(),
            'process' => 1,
            'company_as' => $company_as,
            'country_type' => 'us-exports',
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUsExports\Add:table_contact_history.html.twig', $params),
                    's_cache' => ''
                    )
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/us-exports/jsonp",
     *   name     = "member_search_shipments_result_us_exports_ajax_jsonp",
     *  options={"expose"=true}
     * )
     *
     */
    ...
    $queryDSL = $this->queryDSL($s_cache, "record_date", "item_description", $fields, $size, $page);
...
foreach ($res->getCurrentPageResults()->getResults() as $r) {
    ...
    data-whatever="' . $r->getHit()["_source"]['shipper_name'] . '"
    class="j-modal-company-one-shipments"
    data-toggle="modal" data-target="#myModal" data-backdrop="static"
    data-url="' . $this->generateUrl('company_display_one_shipments_us_exports', array(
    ...
    foreach ($fieldUsCustom->field_us_custom as $col) {
        ...
        if ($col == "item_description") {
           $columnMd[$col] = preg_replace("/<br\W*?\/>/", ", ", $r->getHit()["_source"][$col]);
            // if ($col == "item_description" and isset($r->getHit()["highlight"])) {
...
return new Response(
    ...
    /**
     * @Route(
     *   "/save-bol-shipments-us-export",
     *   name     = "member_save_bol_us_exports"
     * )
     *
     *
     */
    ...
    /**
     * @Route(
     *   "/search-shipments-contact-company-us-exports/us-exports/{company_as}/{page}",
     *   name     = "member_search_result_contact_company_us_exports"
     * )
     *
     */
    public function contactCompanyAction($company_as, $page = 1)
    {
        ...
        $queryDSL = $this->queryDSL($s_cache, "record_date", "item_description", $fields, $size, $page,$aggs);
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsUsExports\Add:contact_company.html.twig', $params),
                    's_cache' => '',
    ...
    /**
     * @Route(
     *   "/search-shipments-result-new-time/us-exports",
     *   name     = "member_search_shipments_result_new_time_us_exports",
     *  options={"expose"=true}
     * )
     *
     * 
    ...
    return $this->redirectUrl('member_search_shipments_result_us_exports',array('s_cache' => $s_cache));
     ...
     /**
     * @Route(
     *   "/search-shipments-result-submit/us-exports",
     *   name     = "member_search_shipments_result_submit_ajax_us_exports",
     *  options={"expose"=true}
     * )
     * @Method("POST")    
     */
     public function resultAjaxAction(Request $request)
     {
        ...
        return new Response(json_encode(array(
            'url' => $this->generateUrl('member_search_shipments_result_us_exports_ajax_jsonp',array('s_cache' => $s_cache)),
            'url_change' => $this->generateUrl('member_search_shipments_result_us_exports',array('s_cache' => $this->s_cache_json)),
            "url_save" => $this->generateUrl("member_display_modal_save_shipments",array("slug_country_subscription" => "us-exports","s_cache" => $this->s_cache_json)),
            "url_export" => $this->generateUrl("member_display_modal_exports_shipments",array("collection" => "us-exports","s_cache" => $this->s_cache_json)),
            "url_contact_company" =>$this->generateUrl("member_search_result_contact_company_us_exports",array("company_as" => "consignee_name","s_cache" => $this->s_cache_json))
            )));
    ...
    $urlChanges = $this->generateUrl('member_search_shipments_result_us_exports',array('s_cache' => $this->s_cache_json));
...
$jsonp = array(
    ...
    "url_save" => $this->generateUrl("member_display_modal_save_shipments",array("slug_country_subscription" => "us-exports","s_cache" => $this->s_cache_json)),
    "url_export" => $this->generateUrl("member_display_modal_exports_shipments",array("collection" => "us-exports","s_cache" => $this->s_cache_json)),
    "url_contact_company" =>$this->generateUrl("member_search_result_contact_company_us_exports",array("company_as" => "shipper_name","s_cache" => $this->s_cache_json))
    );
...
/**
     * @Route(
     *   "/search-contact-company-us-export",
     *   name     = "member_search_contact_company_us_exports"
     * )
     * @Method("POST")
     *
     */
