...
class MemberEmailControllerTest extends WebTestCase
{
    /*
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'jariff_memberbundle_memberemailtype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'jariff_memberbundle_memberemailtype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
