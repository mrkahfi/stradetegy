 ...
 * @Route("/member")
 */
class SearchShipmentsMXExportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/mx-exports/{page}",
     *   name     = "member_search_shipments_result_mx_exports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsMxExports:results.html.twig")
     */
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/mx-exports/{page}",
     *   name     = "member_search_shipments_result_mx_exports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsMxExports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_mx_exports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_mx_exports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsMxExports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_mx_exports', array('page' => $page, 's_cache' => $this->s_cache_json))
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-mx-exports",
     *   name     = "member_search_columns_category_submit_mx_exports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        return $this->redirectUrl('member_search_shipments_result_mx_exports', array('s_cache' => $s_cache));

    }

    /**
     * @Route(
     *   "/search-shipments-columns-show-mx-exports",
     *   name     = "member_search_columns_category_columns_show_mx_exports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsMxExports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/company-display-one-shipments-mx-exports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_mx_exports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsMxExports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,"params" => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/mx-exports/jsonp",
     *   name     = "member_search_shipments_result_mx_exports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        }
    ...
    if ($res->getNbResults() == 0) {
        ...
        $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_mx_exports', array('s_cache' => $this->s_cache_json)));
...
$urlChanges = $this->generateUrl('member_search_shipments_result_mx_exports', array('page' => $page, 's_cache' => $this->s_cache_json));
...
foreach ($res->getCurrentPageResults()->getResults() as $r) {
    ...
    data-url="' . $this->generateUrl('company_display_one_shipments_mx_exports', array(
