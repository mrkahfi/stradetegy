 ...
 * @subpackage AuthorizeNetAIM
 */
class AIM extends AuthorizeNet\Request
{
    ...
    public function setField($name, $value)
    {
        if ($this->verify_x_fields) {
            if (in_array($name, $this->_all_aim_fields)) {
                ...
                throw new \Exception("Error: no field $name exists in the AIM API.
    ...
    {
        return new AIMResponse($response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields);
    }
