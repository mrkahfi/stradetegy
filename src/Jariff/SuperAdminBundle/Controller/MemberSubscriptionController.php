...
class MemberSubscriptionController extends BaseController
{
     ...
     *     name = "super_admin_member_cancel_request_update",
     *     requirements = {
     *       "id"  : "\d+"
     *     }
     * )
     ...
     *     name = "super_admin_member_cancel_request",
     *     requirements = {
     *       "id"  : "\d+"
     *     }
     * )
     ...
     *     name = "super_admin_member_subscription_json_index",
     *     options = {"expose"=true}
     * )
     * @Method("GET")
     */
     ...
     *
     * @Route("/super-admin/member/subscription/create", name="super_admin_subscription_create")
     * @Method("POST")
    ...
    */
     ...
     *     name = "super_admin_member_subscription_new",
     *     requirements = {
     *       "id"  : "\d+"
     *     }
     * )
     ...
     *
     * @Route("/super-admin/member/subscription/delete/{id}", name="super_admin_subscription_delete")
     * @Method("DELETE")
     */
