...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\BRExports\FieldBrExportFormType;
 ...
 * @Route("/member")
 */
class SearchShipmentsBRExportsController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-shipments-result/br-exports/{page}",
     *   name     = "member_search_shipments_result_br_exports",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsBrExports:results.html.twig")
     */
    public function resultAction($page = 1)
    {
        ...
        if (empty($s_cache->column))
            $fieldUsCustom->field_us_custom = array('date', 'customs', 'via',
        ...
        $formFieldUsCustom = $this->createForm(new FieldBrExportFormType(), $fieldUsCustom, array(
            'action' => '',
            'method' => 'POST',
            ));
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/br-exports/{page}",
     *   name     = "member_search_shipments_result_br_exports_ajax",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
     ...
     * )
     *
     * @Template("JariffMemberBundle:Search\ShipmentsBrExports\Add:results_ajax.html.twig")
     */
    public function resultAjaxAction($page = 1)
    {
        ...
        $searchable = new Index($client, 'stradetegy_br_exports');
        ...
        $html = $view->render($res, function ($page) {
            return $this->generateUrl('member_search_shipments_result_br_exports_ajax', array('page' => $page, 's_cache' => $this->s_cache_json));
        }, $options);
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsBrExports\Add:results_ajax.html.twig', $params),
                    's_cache' => $this->s_cache_json,
                    'url_changes' => $this->generateUrl('member_search_shipments_result_br_exports', array('page' => $page, 's_cache' => $this->s_cache_json))
                    )
                )
            );
    }
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-show-br-exports",
     *   name     = "member_search_columns_category_columns_show_br_exports"
     * )
     *
     *
     */
    public function showChoiceColoumnAction(Request $request)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsBrExports\Add\Form:field_column.html.twig', $params),
    ...
    /**
     * @Route(
     *   "/search-shipments-columns-submit-br-exports",
     *   name     = "member_search_columns_category_submit_br_exports"
     * )
     * @Method("POST")
     *
     */
    public function submitCategoryAction(Request $request)
    {
        ...
        $form = $this->createForm(new FieldBrExportFormType(), $entity, array(
            'action' => '',
            'method' => 'POST',
            ));
        ...
        return $this->redirectUrl('member_search_shipments_result_br_exports', array('s_cache' => $s_cache));

    }

    /**
     * @Route(
     *   "/company-display-one-shipments-br-exports/{index}/{type}/{objId}",
     *   name     = "company_display_one_shipments_br_exports",
     *  options={"expose"=true}
     * )
     *
     *
    ...
    function displayOneShipmentsAction($index, $type, $objId)
    {
        ...
        return new Response(
            json_encode(
                array(
                    'success' => true,
                    'html_string' => $this->renderView('JariffMemberBundle:Search\ShipmentsBrExports\Add:modal_show_one_shipments.html.twig', array('entity' => $ret,'params' => $params)),
    ...
    /**
     * @Route(
     *   "/search-shipments-result-ajax/br-exports/jsonp",
     *   name     = "member_search_shipments_result_br_exports_ajax_jsonp",
     *   defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
if ($res->getNbResults() == 0) {
    ...
    $inbound->setVisitedPage($this->generateUrl('member_search_shipments_result_br_exports', array('s_cache' => $this->s_cache_json)));
...
if ($maxTime > 1) {
    ...
    $urlChanges = $this->generateUrl('member_search_shipments_result_br_exports', array('page' => $page, 's_cache' => $this->s_cache_json));
...
foreach ($res->getCurrentPageResults()->getResults() as $r) {
    ...
    data-whatever="'.$r->getHit()["_source"]['nomen'].'"
    class="j-modal-company-one-shipments"
    data-toggle="modal" data-target="#myModal" data-backdrop="static"
    data-url="' . $this->generateUrl('company_display_one_shipments_br_exports', array(
