...
class MemberAttachmentController extends BaseController
{
     ...
     *
     * @Route("/create", name="admin_attachment_create")
     * @Route(
     *     "/create/{type}",
     *     name = "admin_attachment_create",
     *     requirements = {
    ...
    */
     ...
     *
     * @Route("/shoe/{id}", name="admin_attachment_show")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_attachment_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="admin_attachment_update")
     * @Method("PUT")
     ...
     *
     * @Route("/{id}", name="admin_attachment_delete")
     * @Method("DELETE")
     */
