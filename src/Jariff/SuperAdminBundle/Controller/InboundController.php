...
class InboundController extends BaseController
{
     ...
     * @Route(
     *     "/json-index",
     *     name = "super_admin_inbound_json_index",
     *     options = {"expose"=true}
     * )
     * @Method("GET")
     */
     ...
     * @Route(
     *     "/index", 
     *     name="super_admin_inbound_index"
     * )
     * @Method("GET")
     * @Template()
     */
     ...
     * @Route(
     *     "/{id}/attach", 
     *     name="super_admin_inbound_attach"
     * )
     * @Method("GET")
     * @Template()
     */
     ...
     *     name="super_admin_inbound_attach_to_lead",
     *     options = {"expose"=true}
     * )
     * @Method("GET")
     * @Template()
     ...
     * @Route(
     *     "/{id}/previous-client", 
     *     name="super_admin_inbound_previous_client"
     * )
     * @Method("GET")
     * @Template()
     */
     ...
     *     name="super_admin_inbound_previous_client_submit",
     *     options = {"expose"=true}
     * )
     * @Method("GET")
     * @Template()
     ...
     * @Route(
     *     "/{id}/convert", 
     *     name="super_admin_inbound_convert"
     * )
     * @Method("GET")
     * @Template()
     */
     ...
     * @Route(
     *     "/{id}/check-flag", 
     *     name="super_admin_inbound_check_flag"
     * )
     * @Method("GET")
     */
     ...
     * @Route(
     *     "/{id}/queue/{queue}", 
     *     name="super_admin_inbound_queue",
     *     requirements = {
     *       "id"  : "\d+",
     ...
     * @Route(
     *     "/{id}/status/{status}", 
     *     name="super_admin_inbound_status",
     *     requirements = {
     *       "id"  : "\d+",
     ...
     * @Route(
     *     "/{id}/answer/{message}", 
     *     name="super_admin_inbound_quick_answer",
     *     requirements = {
     *       "id"  : "\d+",
