...
use Jariff\MemberBundle\Form\SearchGlobal\Shipments\BRExports\FieldCollectFormBRExportType;
use Jariff\MemberBundle\Form\SearchGlobal\Field\FieldQFormType;


class SearchShipmentsBrExportEmbedFormType extends AbstractType
{
        ...
        $builder
           ->add('collect', 'collection',
                array(
                    ...
                    'type' => new FieldCollectFormBRExportType(),
                    'by_reference' => false,
                    'allow_delete' => true,
                    'allow_add'    => true,
