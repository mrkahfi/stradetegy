...
class MemberEmailController extends BaseController
{
     ...
     *     name = "super_admin_member_email_json_index",
     *     options = {"expose"=true}
     * )
     * @Method("GET")
     */
     ...
     *
     * @Route("/super-admin/member/email/create", name="super_admin_member_email_create")
     * @Template("JariffAdminBundle:MemberEmail:new.html.twig")
     */
    ...
    */
     ...
     *     name = "super_admin_member_email_new",
     *     requirements = {
     *       "id"  : "\d+"
     *     }
     * )
    ...
    */
     ...
     *
     * @Route("/super-admin/email/{id}/update", name="email_update")
     * @Method("PUT")
     * @Template("JariffAdminBundle:MemberEmail:new.html.twig")
     */
     ...
     *
     * @Route("/super-admin/email{id}", name="super_admin_member_email_delete")
     * @Method("DELETE")
     */
