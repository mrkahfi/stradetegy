...
class SearchFilterAjaxController extends BaseController
{
    ...
    /**
     * @Route(
     *   "/search-filter-ajax/{page}",
     *   name     = "member_search_filter_ajax",
     *  defaults = {
     *     "page"  : "1"
     *   },
     *   requirements = {
...
//        start here
        ...
        $check = $this->repoMongo("JariffDocumentBundle:CacheChoice")->findBy(array('user_id' => $username));
...
//        start here
    ...
    /**
     * @Route(
     *   "/search-fix-total-product",
     *   name     = "member_search_fix_ajax_total_product",
     *  options={"expose"=true}
     * )
     *
     *
