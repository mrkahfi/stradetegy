...
class MemberARBController extends BaseController
{
    ...
    */
     ...
     *
     * @Route("/{id}", name="admin_arb_update")
     * @Method("PUT")
     ...
     *
     * @Route("/delete/{token}", name="admin_arb_delete")
     */
